...
#
# Rebases onto main, then fast-forwards main by merging --ff-only inside
# whichever working tree has main checked out (git 2.54 forbids moving a
# checked-out ref, so the old no-checkout fetch is dead).
