  ...
  return [
    ...
    ...(channelEnabled
      ? [
          ...
          '- `orb` -- speak a short line aloud to the user through the voice orb. `orb` = every orb the user has open; `orb:<id>` = one specific orb (the orb hands you its `orb:<id>` when it wants the reply to come back to it). Fire-and-forget: nobody may be listening.',
