...
export function filterRelevantEnv(
  ...
  // stored forever on the concentrator. Safer to mask.
 ...
 */
export function beginLaunch(ctx: WrapperContext, phase: WrapperLaunchPhase): string {
...
export function replayLaunchEvents(ctx: WrapperContext): void {
