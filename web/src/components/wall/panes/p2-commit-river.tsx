...
import { useWallFilter, useWallFilterStore, type WallAxis, type WallRowFacets } from '@/lib/wall/filter'
...
/**
 * THE PROJECT CHIP. Intercepted on the way DOWN, exactly as P1 does it: the tag
 * renders inside a row that is already a click target, so it cannot be its own
 * button. It calls the store's exported action -- there is one implementation of
 * "scope to this project, or clear it if it already is the scope" in this tree
