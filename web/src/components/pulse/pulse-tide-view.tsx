    ...
    <div className="py-1">
      {rows.map(row => {
        ...
        return (
          <Fragment key={row.id}>
            {marks.map(label => (
              <div key={label} className="flex items-center gap-3 pl-[62px] pr-4 pt-3 pb-2">
            ...
            <button
              ...
              className={cn(
                ...
                row.id === activeId ? 'bg-primary/15' : 'hover:bg-primary/10',
              )}
            >
              <span
                className={cn(
              ...
              <span className="relative self-stretch">
                ...
                />
                {needs && (
                  <span className="absolute left-[2px] top-[5px] text-[9px] font-mono text-background z-[1]">
                    {style.icon}
                  </span>
                )}
              </span>
