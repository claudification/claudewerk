        ...
        <DialogPrimitive.Content className="fixed left-1/2 top-1/2 z-50 w-[min(560px,95vw)] -translate-x-1/2 -translate-y-1/2 rounded-md border border-border bg-popover shadow-lg flex flex-col">
          ...
          <div className="p-2">
            <textarea
              ...
              className="w-full h-44 resize-none bg-muted/20 border border-border rounded p-2 text-xs text-foreground outline-none focus:border-accent/60 placeholder:text-fg-faint"
            />
          </div>
