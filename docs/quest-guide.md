...
| **The Guard** | The werk-verifier. An LLM that runs the acceptance command and *distrusts the worker* ("reject aggressively"). Gated behind deterministic machine checks. |
